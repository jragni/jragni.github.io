...
export function Layout({ children }: LayoutProps) {
  return (
    <div className="min-h-screen bg-background grid-overlay-subtle">
      ...
      <div className="fixed top-0 left-0 w-16 h-16 border-l-2 border-t-2 border-primary/20 pointer-events-none z-40" />
      <div className="fixed top-0 right-0 w-16 h-16 border-r-2 border-t-2 border-primary/20 pointer-events-none z-40" />
      <div className="fixed bottom-0 left-0 w-16 h-16 border-l-2 border-b-2 border-primary/20 pointer-events-none z-40" />
      <div className="fixed bottom-0 right-0 w-16 h-16 border-r-2 border-b-2 border-primary/20 pointer-events-none z-40" />
